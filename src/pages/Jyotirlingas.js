...
const Jyotirlingas = () => {
  ...
  const jyotirlingas = [
    { num: 1, name: "Somnath Jyotirlinga", location: "Prabhas Patan, Gujarat", desc: "The first and most sacred of the 12 Jyotirlingas, Somnath is located on the western coast of Gujarat.", image: "https://www.citybit.in/wp-content/uploads/2023/07/Somnath-Jyotirlinga-Image.jpg", 
    ...
    { num: 2, name: "Mallikarjuna Jyotirlinga", location: "Srisailam, Andhra Pradesh", desc: "Located on the sacred Srisailam hill, Mallikarjuna is one of the most powerful Jyotirlingas.", image: "https://www.citybit.in/wp-content/uploads/2023/07/Mallikarjuna-Jyotirlinga-Image.jpg",
    ...
    { num: 3, name: "Mahakaleshwar Jyotirlinga", location: "Ujjain, Madhya Pradesh", desc: "Mahakaleshwar in Ujjain is one of the most powerful Jyotirlingas, known for its unique Bhasma Aarti ritual.", image: "https://www.citybit.in/wp-content/uploads/2023/07/Mahakaleshwar-Jyotirlinga-Image.jpg",
    ...
    { num: 4, name: "Omkareshwar Jyotirlinga", location: "Omkareshwar, Madhya Pradesh", desc: "Omkareshwar is situated on an island in the Narmada river, shaped like the sacred 'Om' symbol.", image: "https://www.citybit.in/wp-content/uploads/2023/07/Omkareshwar-Jyotirlinga-Image.jpg",
    ...
    { num: 5, name: "Kedarnath Jyotirlinga", location: "Kedarnath, Uttarakhand", desc: "Kedarnath is the highest Jyotirlinga, located at an altitude of 3,583 meters in the Garhwal Himalayas.", image: "https://www.citybit.in/wp-content/uploads/2023/07/Kedarnath-Jyotirlinga-Image.jpg",
    ...
    { num: 6, name: "Bhimashankar Jyotirlinga", location: "Bhimashankar, Maharashtra", desc: "Bhimashankar is located in the Sahyadri hills of Maharashtra, surrounded by dense forests and wildlife.", image: "https://www.citybit.in/wp-content/uploads/2023/07/Bhimashankar-Jyotirlinga-Image.jpg",
    ...
    { num: 7, name: "Kashi Vishwanath Jyotirlinga", location: "Varanasi, Uttar Pradesh", desc: "Kashi Vishwanath is the most sacred Jyotirlinga, located in the holy city of Varanasi.", image: "https://www.citybit.in/wp-content/uploads/2023/07/Kashi-Vishwanath-Jyotirlinga-Image.jpg",
    ...
    { num: 8, name: "Trimbakeshwar Jyotirlinga", location: "Trimbak, Maharashtra", desc: "Trimbakeshwar is located near the source of the sacred Godavari river.", image: "https://www.citybit.in/wp-content/uploads/2023/07/Trimbakeshwar-Jyotirlinga-Image.jpg",
    ...
    { num: 9, name: "Vaidyanath Jyotirlinga", location: "Deoghar, Jharkhand", desc: "Vaidyanath, also known as Baidyanath, is the divine physician form of Lord Shiva.", image: "https://www.citybit.in/wp-content/uploads/2023/07/Vaidyanath-Jyotirlinga-Image.jpg",
    ...
    { num: 10, name: "Nageshwar Jyotirlinga", location: "Dwarka, Gujarat", desc: "Nageshwar is located near the holy city of Dwarka and is associated with the legend of Lord Shiva protecting his devotees.", image: "https://www.citybit.in/wp-content/uploads/2023/07/Nageshwar-Jyotirlinga-Image.jpg",
    ...
    { num: 11, name: "Rameshwar Jyotirlinga", location: "Rameswaram, Tamil Nadu", desc: "Rameshwar is located on the sacred island of Rameswaram and is associated with Lord Rama's worship of Shiva.", image: "https://www.citybit.in/wp-content/uploads/2023/07/Rameshwaram-Jyotirlinga-Image.jpg",
    ...
    { num: 12, name: "Grishneshwar Jyotirlinga", location: "Ellora, Maharashtra", desc: "Grishneshwar is located near the famous Ellora caves and is the last of the 12 Jyotirlingas.", image: "https://www.citybit.in/wp-content/uploads/2023/07/Grishneshwar-Jyotirlinga-Image.jpg",
        ...
        {jyotirlingas.map(jyotirlinga => (
          <div key={jyotirlinga.num} className="jyotirlinga-card" onClick={() => setSelectedJyotirlinga(jyotirlinga)}>
            <div className="card-image">
              <img src={jyotirlinga.image} alt={jyotirlinga.name} onError={(e) => { e.target.src = "https://upload.wikimedia.org/wikipedia/commons/thumb/3/30/Kedarnath_Temple.jpg/800px-Kedarnath_Temple.jpg"; }} />
            </div>
        ...
        <div className="modal-overlay" onClick={() => setSelectedJyotirlinga(null)}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-image">
              <img src={selectedJyotirlinga.image} alt={selectedJyotirlinga.name} />
            </div>
